...
if($paro_id!="")  
{
		...
		$consulta22  = "SELECT cut_pause.id, TIME_TO_SEC(timediff(now(), inicio))/60, cut_pause.razon_id, down_time_reason.autorization   FROM cut_pause inner join down_time_reason on cut_pause.razon_id=down_time_reason.id where id=".$paro_id;
