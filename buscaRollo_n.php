...
{	
	$dato="";
	$dato=" <label for=\"location_id\">Rollo:</label>Capturar Long. <select class=\"form-control\" id=\"roll_id\" name=\"roll_id\" ><option value=\"0\" selected=\"selected\">--Selecciona Rollo--</option>";
	...
	$dato="$dato </select><br>Long.<input type=\"text\" class=\"form-control\" id=\"longitud\" name=\"longitud\" value=\"\"/><br>Long. Defecto<input type=\"text\" class=\"form-control\" id=\"longitud_def\" name=\"longitud_def\" value=\"\"/>";
