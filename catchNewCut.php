...
$status= $_POST["status"];
$defectSwitch=$_POST["defectSwitch"];
$utilizado=$length+$lengthDefect;
	...
	$consulta22  = "SELECT count(id)   FROM cut_pause where location_id=$location_id  and autorized=0";// id_cut=$cut_id
...
if($pausas=="0")
{
	...
	$consulta2  = "SELECT length_consumed, length_defect,length_parcial, length_defect_parcial, roll_id, location_assigned_id, 
	short_length, short_length_defect, short_time_stamp, short_type, prev_short, prev_short_defect  FROM cuts where id=$cut_id ";
