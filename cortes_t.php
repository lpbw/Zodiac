<?
    ...
    if($_POST['estatus_b'] != "" && $_POST['estatus_b'] != "Estatus")
    {
        $es = $_POST['estatus_b'];
    }
    ...
    <head>
        ...
        <?
            ...
            {			
                ...
                else		
                {
                    ...
                    if($_POST["id_cut_type"]=="6")// si es Daily
					{
								$consultal  = "SELECT id, name FROM locations where deleted_at is null";
								$resultadol = mysql_query($consultal) or die("La consulta fall&oacute;P1: " . mysql_error());
								$countl=1;
								while(@mysql_num_rows($resultadol)>=$countl)
								{
									$resl=mysql_fetch_row($resultadol);
									
									$consulta6="select max(orden) as orden from cuts where location_assigned_id=".$resl[0]." and status<3 and deleted_at is null";
									$resultado6 = mysql_query($consulta6) or die("Error en operacion1: $consulta6 " . mysql_error());
									$res6=mysql_fetch_assoc($resultado6);
									$orden=$res6['orden'];
									if($orden>0)
            ...
            if($borrar!="")  
            {
                ...
                $consulta  =  "delete from cuts  where id=$borrar and status not in(1,2)";
                $resultado = mysql_query($consulta) or die("Error en operacion1: $consulta " . mysql_error());
            ...
            if ($eliminar == "Borrar") 
            {
                ...
                echo"<script>alert(\"Cortes Borrado\");</script>";
            }	
        ?>
        ...
        <script>
            function ValidaBorrar(){
                //console.log("entro");
                var resp = confirm("Desea eliminar los programas seleccionados");
                if (resp == true) {
                    //console.log("si");
                    return true;
                }else{
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        <img class="img-responsive" src="public/images/zodiac.jpg" alt="zodiac logo"/>
                    </a>
                </div>
                <!-- /.navbar-header -->
                <?
                    ...
                    <div class="col-lg-12">
                        ...
                        <div>
                            <div align="right"  class="popup">
                                <strong>
                                    <span class="style1 bg-primary" style="cursor:pointer;" onClick="myFunction()">&nbsp;&nbsp;?&nbsp;&nbsp;</span>
                                </strong>
                                <span class="popuptext" id="myPopup">
                                    ...
                                    <p align="left">
                                        Permite crear nuevas ordenes, tambien muestra la lista de cortes pendientes de procesar y permite buscar, editar y borrar cortes en los demas estatus y maquinas .
                                    </p>
                                    <div align="left">
                                        <ul>
                        ...
                        <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                        
                            ...
                            <div class="form-group">
                                ...
                                <!-- 
                                    tipo de corte
                                    funcion buscarParche
                                 -->
							    <div class="col-sm-6 col-md-4 col-lg-2">
                                    <label for="remaining_inches">Tipo de Corte:</label>
                                    <select class="form-control" id="id_cut_type" name="id_cut_type" onChange="buscaParche();" required>
                                    ...
                                    <!-- programa -->
							        <div class="col-sm-6 col-md-4 col-lg-2"  id="d_prog">
                                        <label for="id_p">
                                            Programa:
                                        </label>
                                        <input type="text" name="fiber_id" list="id_pro" id="id_p" class="form-control" required>
                                        <datalist id="id_pro">
                                            <?	
                                    ...
                                    <!-- captura longuitud -->
                                    <div class="col-sm-6 col-md-4 col-lg-2" id="d_cap"><?  if($tipoU=="1"){?>
                                        <label for="captura">
                                            Captura Long:
                                        </label> 
                                    ...
                                    <div class="col-sm-6 col-md-12 col-lg-3">
                                        <input type="submit" class="btn red-submit button-form" name="guardar" value="Guardar" onClick="return validar()";/>
                                        <input type="button" class="btn red-submit button-form" name="guardar2" value="Cancelar" onClick="window.location='cortes.php';"/>
                                    </div>
                                ...
                                <script>
                                    function cambiar()
                                    {
                                        ...
                                        <? 
                                            ...
                                            {
                                        ?>
                                                if(index==<? echo $contador2;?>)
                                                {
                                                    objetivo<? echo $contador2;?>();
                                                }
                                        <? 
                                                $contador2++; 
                                            }
					    ...
					    <form name="form2" action="" method="post" class="margin-bottom" accept-charset="utf-8">
				                ...
				                <table class="table table-striped table-condensed">
				                    <thead>
				                        <tr>
				                            ...
				                            <th colspan="3">
                                                <select class="form-control" id="lugar_b" name="lugar_b"  style="width:150" onChange="seleccionaLugar()">
                                                    ...
                                                    <?	  
                                                        ...
                                                        {
                                                    ?>
                                                            <option value="<? echo $res['id'];?>" <? echo $res['id']==$lugar?"selected":"";?>><? echo $res['name'];?></option>
                                                    <?
                                                        }
                                                    ?>
                                                </select>
                                            ...
                                            <!-- boton buscar -->
                                            <th>
                                                <span class="col-sm-6 col-md-12 col-lg-3">
                                            ...
                                            <th>
                                                <span class="col-sm-12 col-md-6 col-lg-6">
                                                    <input type="submit" class="btn red-submit button-form" name="eliminar" id="eliminar" value="Borrar" onClick="return ValidaBorrar();"/>
                                                </span>
                                            </th>
				                        </tr>
				                    </thead>
                            ...
                            <!-- tabla resultados busqueda por filtro -->
                            <div class="col-lg-12 table-responsive">
                                Programadas
                                <table class="table table-striped table-condensed">
                                    <thead>
	                                ...
	                                <?	  	 
                                        if($_POST['buscar']=="Buscar" || $lugar != 0 || $es != "Estatus")
                                        { 
                                            $est = ""; 
                                            $lug=$_POST['lugar_b'];
                                            $est=$_POST['estatus_b'];
                                            ...
                                            if($lug!="0" && $lug!="")
                                            {
                                                $buscarr=" location_assigned_id=".$lug." and ";
                                            }
                                            if($est!="Estatus")
                                            {
                                                if($est=="0")
                                            ...
                                            $consulta .= "WHERE cuts.deleted_at IS NULL AND $buscarr $estat ORDER BY name,orden";
	                                    }
	                                    else
                                        {
	                                        $buscarr=" location_assigned_id<>0 and ";
                                            ...
                                            $consulta .= "LEFT OUTER JOIN location_capacities ON location_capacities.id=cuts.number_position "; 
                                            $consulta .= "LEFT OUTER JOIN locations ON cuts.location_assigned_id=locations.id ";
                                            $consulta .= "WHERE cuts.deleted_at IS NULL AND $buscarr status=0 ORDER BY name,orden";
	                                    }
	                                    $resultado = mysql_query($consulta) or die("La consulta fall&oacute;P1: " . mysql_error());
	                                    while($res=mysql_fetch_assoc($resultado))
                                        {
                                    ?>
										    <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="editar_corte.php?id=<? echo $res['id']; ?>&lug=<? echo $lug; ?>&es=<? echo $es; ?>" class="iframe2">
