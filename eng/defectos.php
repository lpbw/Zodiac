...
if($guardar=="Save")  
{
	...
	if($id!="")
	echo"<script>alert(\"Defect Changed\");</script>";
	else
	echo"<script>alert(\"Defecto Added\");</script>";
...
if($borrar!="")  
{
	...
	echo"<script>alert(\"Defect Erased\");</script>";
...
function borrar(id)
{
  if(confirm("Are you shure to delete this defect?"))
  {
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div id="page-wrapper">
        <div class="row">
                <h1 class="page-header">Defects</h1>
