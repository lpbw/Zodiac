...
if($guardar=="Save")  
{
	...
	echo"<script>alert(\"Fabril changed\");</script>";
	}
	else
	{
		...
		if(@mysql_num_rows($resultado)>=1)
		{
			...
			echo"<script>alert(\"Fabric already exist\");</script>";
		...
		else
		{
			...
			$resultado = mysql_query($consulta) or die("Error en operacion1: $consulta " . mysql_error());
			echo"<script>alert(\"Fabric Added\");</script>";
		}
	}
...
if($borrar!="")  
{
		...
		{
			$res=mysql_fetch_row($resultado);
			echo"<script>alert(\"Cant delete fabric , Assigned to roll $res[0]\");</script>";
		}else
		{
				...
				echo"<script>alert(\"Fabril deleted\");</script>";
		}
	/*echo"<script>parent.tb_remove(); parent.location=\"adm_planes.php\"</script>";*/
}
if($id!="")
...
function borrar(id)
{
  if(confirm("¿Are you shure to delete this fabric?"))
  {
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                                                
                  <div class="form-group">
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="fiber_id">Supplier:</label>
                                <input name="borrar" type="hidden" id="borrar">
                                <input name="id" type="hidden" id="id" value="<?echo"$id";?>">
                                <select class="form-control" id="proveedor" name="proveedor">
								<option value="0" selected="selected">--Choose Fabric--</option>
     <?	  
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>    
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches"> Fabric:</label>
                                <input type="text" class="form-control" id="fibra" name="fibra"
                                       value=""/>
                    </div>
					<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Description :</label>
                                <input type="text" class="form-control" id="texto" name="texto"
                                       value=""/>
                    </div>
					<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Format:</label>
