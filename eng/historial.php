   ...
   <? include "menu_f.php"?>
    ...
    <div id="page-wrapper">
        <div class="row">
			 ...
			 <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="guaranteed_length">MO number:</label>
                                <span class="col-sm-6 col-md-4 col-lg-4">
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
				...
				<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="guaranteed_length">Operator:</label>
                                <span class="col-sm-6 col-md-4 col-lg-4">
