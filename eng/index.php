...
<input type="hidden" name="token" value="cf9cc6b1e3dac94c4ce6cf18274b6c02" />
					...
					<select  name="lang" id="lang">
					 <option value="3">--Choose Language--</option>
                      <?	  
	                    ...
	                    $count=1;
	                     ...
	                     {
	                       ?>
    	                    <option value="<? echo $res['lang']?>"><? echo $res['language']?></option>
	                       <?
	                     } 
		               ?>    
                    </select>
					</div><br>
                    <input type="submit" name="submit" value="Sing In" title="Iniciar sesión" class="btn red-submit" />                    
                    </form>                                    </div>
                </div>
            </div>
        </div>
