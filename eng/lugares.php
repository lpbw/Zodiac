...
if($guardar=="Save")  
{
	...
	//echo"<script>alert(\"$capacity Posiciones Agregadas\");</script>";
	if($id!="")
	echo"<script>alert(\"Location Changed\");</script>";
	else
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div id="page-wrapper">
        <div class="row">
                <h1 class="page-header">Location(Lectra)</h1>
            
                <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                                                
                  <div class="form-group">
                            
						<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Lectra:</label>
                                <input name="id" type="hidden" id="id" value="<?echo"$id";?>">
                                <input type="text" class="form-control" id="lugar" name="lugar"
                                       value=""/ required>
                  </div>
				  <div class="col-sm-6 col-md-4 col-lg-2">
                                <label for="remaining_inches">Sortage Capacity:</label>
				  ...
				  <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="fiber_id">Status:</label>
        ...
        <div class="col-lg-12 table-responsive">
                    ...
                    <thead>
                    <tr><th>Lectra</th>
					<th><div align="center">Sortage Capacity</div></th>
		...
		?>
		 <tr>
			...
			<td class="text-center"><div align="center">
			  <? if($res[4]=="0")echo"Inactive"; else echo"Active"?>
			</div></td>
			<td class="text-center"><? if($res[5]=="0")echo"Non Visible"; else echo"Visible"?></td>
