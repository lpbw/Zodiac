...
if($guardar=="Save")  
{
	...
	if($id!="")
	{
	echo"<script>alert(\"Part number changed\");</script>";
	$id= "";
	
	}
	else
	echo"<script>alert(\"Part number added\");</script>";
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div id="page-wrapper">
        <div class="row">
                <h1 class="page-header">Part Number</h1>
            
                <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                                                
                  <div class="form-group">
                            
						<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Part Number :</label>
                                <input name="id" type="hidden" id="id" value="<?echo"$id";?>">
                                <input type="text" class="form-control" id="name" name="name"
                                       value=""/ required>
                  </div>
				  <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Product Description :</label>
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
		 <tr>
			<td><? echo"$res[1]"; ?></td>
			<td><? echo"$res[2]"; ?></td>
			<td><a href="parte_fibra.php?parte=<? echo"$res[1]"; ?>" class="style1 iframe3">Edit Fabric</a></td>
