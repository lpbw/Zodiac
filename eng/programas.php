...
if($guardar=="Save")  
{
	...
	if($id!="")
	echo"<script>alert(\"program changed\");</script>";
	else
	echo"<script>alert(\"added program\");</script>";
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div id="page-wrapper">
        ...
        <div class="col-lg-12 table-responsive">
                    ...
                    <thead>
                    <tr><th width="29%">Program</th>
					
                   

                      <th width="28%"><div align="center">Part Number Edit</div></th>
                      <th width="19%"><div align="center">Edit</div></th>
                    <th width="24%"><div align="center">Delete</div></th>
                    </thead>
                    <tbody>
<?	  
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
		 <tr>
			...
			<td class="text-center"><a href="programa_parte.php?prog=<? echo"$res[0]"; ?>" class="style1 iframe3">Part Number Edit</a></td>
