...
if($guardar=="Save")  
{
	...
	if($id!="")
	echo"<script>alert(\"Reason Changed\");</script>";
	else
	echo"<script>alert(\"Reason Added\");</script>";
                ...
                <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                                                
                  <div class="form-group">
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Reason:</label>
                                <input name="id" type="hidden" id="id" value="<?echo"$id";?>">
                                <input type="text" class="form-control" id="name" name="name"
                                       value=""/ required><input name="borrar" type="hidden" id="borrar">
                  </div>
				  <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Autorization Requiered :</label>
                  <select class="form-control" id="autorizacion" name="autorizacion">
								<option value="0">--Not Requiered--</option>
								<option value="1">--Requiered--</option>
				   </select>
                  </div>
