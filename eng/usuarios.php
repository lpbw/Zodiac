...
$consulta  =  "insert into users(username, first_name, last_name,password, level_id, created_at) values('$user', '$first_name', '$last_name', '$password', '$level_id', now())";
	...
	if($id!="")
	echo"<script>alert(\"changed user\");</script>";
	else
        ...
        <div class="row">
                ...
                <form action="" method="post" name="form1" class="margin-bottom" id="form1" accept-charset="utf-8">                                                
				  ...
				  <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">User:</label>
                                <input name="id" type="hidden" id="id" value="<?echo"$id";?>">
                                <input type="text" class="form-control" id="user" name="user"
                                       value=""/>
                    </div>
					<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Name:</label>
                                <input type="text" class="form-control" id="first_name" name="first_name"
                                       value="" required/>
                    </div>
					<div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="remaining_inches">Last Name:</label>
                                <input type="text" class="form-control" id="last_name" name="last_name"
                                       value="" required/>
                    </div>
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <label for="fiber_id">Level:</label>
                                <input name="borrar" type="hidden" id="borrar">
                                <select class="form-control" id="level_id" name="level_id">
								<option value="0" selected="selected">--Choose Level--</option>
     <?	  
