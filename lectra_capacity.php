            ...
            <div class="col-lg-12">
              ...
              <div class="col-lg-12 table-responsive" id="d_terminadas">
							...
							<tr>
							  ...
							  <th colspan="4">
							    <input name="desde" type="text" class="form-control" id="desde"
                                       value="<?echo"$desde";?>" size="10" placeholder="Fecha Desde"  />							  </th>
							  <th colspan="3">
							    <input name="hasta" type="text" class="form-control" id="hasta"
                                       value="<?echo"$hasta";?>" size="10" placeholder="Fecha Hasta">							  </th>
							  <th colspan="5">
							    <select class="form-control" id="lugar_b" name="lugar_b" style="width:150">
                           ...
                           <th width="6%">Long</th>
							...
							<th width="6%">SW Inicio </th>
							<th width="6%">SW Fin </th>
							<th width="6%">HW Inicio</th>
							<th width="4%">HW Fin</th>
	...
	while($res=mysql_fetch_assoc($resultado)){	
		...
		?>
							<tr>
                                    ...
                                    <td  class="text-center"><a href="detalle_pausa.php?id=<? echo $res['cuts_id']; ?>" class="iframe3">
									<? 	$consulta2="SELECT count(cp.id_cut) as pausas from cuts c join cut_pause cp on c.id=cp.id_cut where cp.id_cut=".$res['cuts_id']."";
