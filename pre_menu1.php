...
if($_POST["submit"]!=""){
			...
			if($location!="0")
			{
					...
					if(@mysql_num_rows($resultado2)>=1){
						...
						{
							echo"<script>alert(\"Este usuario esta activo en otra maquina\");</script>";
					...
					}else
					{
						...
						if(@mysql_num_rows($resultado8)>=1){
							...
							$nombre="$res8[0]";
							echo"<script>alert(\"$nombre esta en esta maquina\");</script>";
							echo"<script> window.location=\"index.php\"</script>";
						}else
						{*/
							$_SESSION['location']=$location;
					...
					echo"<script>alert(\"Debe Seleccionar una Maquina\");</script>";
...
<body><div class="jumbotron login-window">
              ...
              <div id="campos_login">
                    ...
                    <form action="" method="post" accept-charset="utf-8">                    <div class="form-group">
                                                ...
                                                <select class="form-control" id="location" name="location">
                                                  <option value="0" selected="selected">--Selecciona Maquina--</option>
                                                  <?	  
	...
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                    ...
                    <div align="center"><a href="eng/pre_menu1.php">English Version </a></div>
              </div>
                </div>
            </div>
        </div>
