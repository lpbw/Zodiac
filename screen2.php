...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div >
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">FSA PANTALLA DE CONTROL  <? //echo"$total_turno $dia_semana";?></h1>
              ...
              <div class="col-lg-12 table-responsive" id="d_pendientes">
                            ...
                            <th width="7%"><span class="style11">Estatus</span></th>
                            <th width="4%">&nbsp;</th>
                            <th width="20%"><span class="style11">Operador</span></th>
                            <th width="9%"><div align="center" class="style11">MO</div></th>
                            <th width="16%"><div align="center" class="style11">Num. de Parte / Programa </div></th>
                            <th width="8%"><div align="center" class="style11">
                              <div align="center">Tiempo Activo </div>
                            </div></th>
                            <th width="6%"><div align="center" class="style11">
                              <div align="center">T.A. <br />
                            MO </div>
                            </div></th>
                            <th width="6%"><div align="center" class="style11">
                              <div align="center">T.M. MO  </div>
                            </div></th>
                            <th width="8%"><div align="center"><span class="style11">Tiempo Comida</span></div></th>
                            <th width="8%"><div align="center" class="style11">
                              <div align="center">Tiempo Paro </div>
                            </div></th>
                            </tr>
                            </thead>
                           <!-- <tbody>-->
		...
		?>
						...
						?>
							<tr >
                                    ...
                                    <td class="style2"><span class="style6"><? if($bpass==0){?><img src="images/bypass.png" width="50" height="32" /><? }?><? echo $razon?>..</span></td>

                                    <td class="style6">&nbsp;</td>
                                


                                    <td class="style2"><div align="right"><span class="style6">
                                    <? if($res['first_name']!="")echo "$tiempo_activo_total  MIN";?>
                                    </span></div></td>
                                    <td class="style6"><div align="right"></div></td>
                                    <td class="style2"><div align="right"><span class="style6"><? echo "$tiempo_paro_parcial MIN";?></span></div></td>
							        <td class="style2"><div align="right"><span class="style6">
							 ...
							 ?>
							  <tr bgcolor="#FFCC33">
                                    <td height="30" bgcolor="#FFCC33" class="style2"><span class="style6"><? echo $res['name']?> </span></td>
                                 
                                    <td bgcolor="#FFCC33" class="style2"><div align="center"><span class="style10">INACTIVO</span></div></td>
                                    <td bgcolor="#FFCC33" class="style2"><table width="100%" border="0" bgcolor="#FF0000">
                                      <tr>
                                        <td height="40" bgcolor="#FF0000">&nbsp;</td>
                                      </tr>
                                    </table></td>
                                    <td bgcolor="#FFCC33" class="style2"><span class="style10"><? echo $res['first_name'] ?> <? echo $res['last_name'] ?></span></td>
                                    <td bgcolor="#FFCC33" class="style2"><span class="style10"><? if($bpass==0){?><img src="images/bypass.png" width="50" height="32" /><? }?><? echo $razon?></span></td>

                                    <td bgcolor="#FFCC33" class="style6">&nbsp;</td>
                                


                                    <td bgcolor="#FFCC33" class="style2"><div align="right"><span class="style10">
                                    <? if($res['first_name']!="")echo "$tiempo_activo_total  MIN";?>
                                    </span></div></td>
                                    <td bgcolor="#FFCC33" class="style6"><div align="right"></div></td>
                                    <td bgcolor="#FFCC33" class="style2"><div align="right"><span class="style10"><? echo "$tiempo_paro_parcial MIN";?></span></div></td>
							        <td bgcolor="#FFCC33" class="style2"><div align="right"><span class="style10">
							          <? if($res['first_name']!="")echo "$tiempo_comida MIN";?>
						            </span></div></td>
							        <td bgcolor="#FFCC33" class="style2"><div align="right"><span class="style10">
